 ...
 */
final class Version20191201122137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, category_id INT DEFAULT NULL, brand_id INT DEFAULT NULL, color_id INT DEFAULT NULL, size_id INT DEFAULT NULL, stock INT NOT NULL, INDEX IDX_4B3656604584665A (product_id), INDEX IDX_4B36566012469DE2 (category_id), INDEX IDX_4B36566044F5D008 (brand_id), INDEX IDX_4B3656607ADA1FB5 (color_id), INDEX IDX_4B365660498DA827 (size_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
